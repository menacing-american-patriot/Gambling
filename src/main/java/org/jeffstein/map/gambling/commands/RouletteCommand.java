...
import org.jeffstein.map.gambling.games.RouletteGUI;
import org.jeffstein.map.gambling.games.RouletteBettingGUI;
...
public class RouletteCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        org.jeffstein.map.gambling.listeners.RouletteListener listener = org.jeffstein.map.gambling.listeners.RouletteListener.getInstance();
        if (listener == null) {
