...
import org.jeffstein.map.gambling.games.BaccaratGUI;
...
public class BaccaratCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        org.jeffstein.map.gambling.listeners.BaccaratListener listener = org.jeffstein.map.gambling.listeners.BaccaratListener.getInstance();
